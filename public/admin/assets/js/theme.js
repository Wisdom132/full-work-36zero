...
(function($) {
  ...
  var Unifato = {
    ...
    setMenu: function(){
      ...
      if(width > 961) {
        document.getElementsByClassName('site-sidebar')[0].style.display = 'block';
      }

      if (width < 961) {
        $(".sidebar-toggle a").show();
        document.getElementsByClassName('site-sidebar')[0].style.display = 'none';
        $('.side-menu').metisMenu({ preventDefault: true });
      }
      ...
      else if ( width > 961 && document.body.classList.contains('sidebar-horizontal') || document.body.classList.contains('sidebar-collapse') ) {
