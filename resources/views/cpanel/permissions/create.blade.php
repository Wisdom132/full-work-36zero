         ...
         <div class="col-md-12 widget-holder">
          <div class="widget-bg">
           <div class="widget-body clearfix">
            <h5 class="box-title mr-b-0">Create Permission</h5>
            <form class="form-material" method="POST" action="{{ route('permission.store') }}">
             @csrf
          ...
          <div class="row">
            <div class="col-lg-6 widget-holder">
             <div class="widget-bg">
              <div class="form-group">
               <select name="for" class="form-control" id="l13">
