			...
			<div class="col-md-12 widget-holder">
				<div class="widget-bg">
					<div class="widget-body clearfix">
						...
						<form id="my-awesome-dropzone" class="form-material" method="POST" action="{{ route('post.update', $posts->id) }}" enctype="multipart/form-data">
							@csrf
							{{ method_field('PUT')}}
							<div class="row">
								<div class="col-lg-6 widget-holder">
									<div class="widget-bg">
										<div class="form-group">
											<input name="title" class="form-control" id="l36" value="{{ $posts->title }}"  type="text">
								...
								<div class="col-lg-12 widget-holder">							
									<div class="widget-bg">
										<div class="widget-body clearfix">
											...
											<textarea name="body" class="form-control" data-toggle="tinymce" data-plugin-options='{ "height": 400 }'>{{ $posts->body }}</textarea>
										</div>
									</div>
								</div>
								...
								<div class="col-md-6 widget-holder">
									<div class="widget-bg">
										<div class="form-group">
											<input type="file" value="{{ $posts->image }}" name="file">
										</div>
										{{-- <div class="widget-body clearfix">
						...
						<div class="form-actions btn-list widget-holder">
							<div class="widget-bg">
								...
								<a href="{{ route('home_view') }}" class="btn btn-outline-default" type="button">Cancel</a>
							</div>
						</div>
					</form>
				</div>
