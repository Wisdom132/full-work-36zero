    ...
    <div id="wrapper" class="wrapper">
        <div class="content-wrapper">
            <main class="main-wrapper">
                ...
                <h4>Access Denied!</h4>
                <p class="mr-t-10 mr-b-20">You don't have permission to access on this server.</p><a href="/home" class="btn btn-info btn-lg btn-rounded mr-b-20 ripple">Go Back</a>
            </main>
        </div>
        <!-- .content-wrapper -->
    </div>
